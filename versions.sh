...
export DAV1D_VERSION=1.4.2
# export RAV1E_VERSION=0.5.1
export AOM_VERSION=3.9.0
...
export HARFBUZZ_VERSION=8.5.0
export PIXMAN_VERSION=0.43.4
export CAIRO_VERSION=1.18.0
export FRIBIDI_VERSION=1.0.14
